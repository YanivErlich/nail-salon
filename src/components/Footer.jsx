...
<a
          ...
          >
            <svg className={styles.socialIcon} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-label="Instagram">
          ...
          <a
            ...
            rel="noreferrer noopener"
          >
            <svg className={styles.socialIcon} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-label="Facebook">
